...
datasets: [        {label: "The Young and the Rest of Us",
            ...
            data: [223.1, 564.2, 1199.6, 1432.8, 1716.0, 1831.1, 2501.7, ]        },
        {label: "Unbeatable Unicorns",
            ...
            data: [188.4, 558.3, 883.2, 1099.9, 1423.0, 1668.8, 2143.9, ]        },
        {label: "HASFAL",
            ...
            data: [130.7, 376.7, 675.3, 909.1, 1153.4, 1288.5, 1490.4, ]        },
        {label: "London Pride",
            ...
            data: [76.7, 162.6, 373.8, 428.6, 576.4, 630.4, 790.6, ]        },
        {label: "Rogue Nation",
            ...
            data: [50.6, 157.5, 222.1, 316.1, 407.4, 521.8, 613.3, ]        },
        {label: "S.M.A.R.T.@DE",
            ...
            data: [85.5, 170.3, 316.8, 318.3, 322.7, 543.5, 614.6, ]        }    ]};