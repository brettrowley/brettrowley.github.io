...
datasets: [        {label: "The Young and the Rest of Us",
            ...
            data: [223.1, 564.2, 1199.6, 1432.8, 1716.0, 1782.0, ]        },
        {label: "Unbeatable Unicorns",
            ...
            data: [188.4, 558.3, 883.2, 1099.9, 1423.0, 1646.3, ]        },
        {label: "HASFAL",
            ...
            data: [130.7, 376.7, 675.3, 909.1, 1153.4, 1239.7, ]        },
        {label: "London Pride",
            ...
            data: [76.7, 162.6, 373.8, 428.6, 576.4, 625.6, ]        },
        {label: "Rogue Nation",
            ...
            data: [50.6, 157.5, 222.1, 316.1, 407.4, 497.1, ]        },
        {label: "S.M.A.R.T.@DE",
            ...
            data: [85.5, 170.3, 316.8, 318.3, 322.7, 539.5, ]        }    ]};